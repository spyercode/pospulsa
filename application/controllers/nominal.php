...
class Nominal extends CI_Controller{
    ...
    function cari(){
        ...
        if(isset($_POST["query"])){
            $query = $this->db->query("SELECT nama_nominal, deskripsi, nama_kategori, nama_proveder FROM nominal WHERE nama_nominal like '%$search%' or deskripsi like '%$search%' or nama_kategori like '%$search%' or nama_proveder like '%$search%'")->result();
        }
    }
}