...
<!-- Awal Coding Lihat Data -->
  ...
  <div class="col-sm-3">.col-sm-3</div>
  <div id="dt-opt-filter" class="dataTables_filter"><label>Search </label><input type="type=" name="search_text" id="search_text" class="form_control-sm" placeholder="Search..." aria-controls="dt-opt"></div>
</div>
				<hr>
